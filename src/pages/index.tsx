    ...
    <>
      ...
      <Container size={928}>
        <Grid columns={24} align='center' justify='space-between'>
          <Grid.Col md={12}>
            <Title>Moss Amazon NFT: the forest preserved in every hectare.</Title>
            <Space h={24} />
            <Text>Become an NFT owner and digitally monitor your part of the Amazon preservation project.</Text>
            <Space h={24} /> 
